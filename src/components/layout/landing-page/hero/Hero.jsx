  ...
  return (
    <>
      <section className="h-[558px] heroimg w-full">
        <div className="w-full bg-[#112420] text-[#FBFBFB] h-full flex justify-center items-center px-3">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex gap-5">
              ...
              <Link
                to={REGISTER}
                className="flex action-button border border-[#3D7100] bg-transparent text-[#FBFBFB]  sm:mr-1"
              >
                learn more
              </Link>
            </div>
