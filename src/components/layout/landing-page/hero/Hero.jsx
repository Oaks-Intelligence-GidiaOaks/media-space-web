  ...
  return (
    <>
      <section className="h-[558px] heroimg w-full">
        <div className="w-full hero bg-[#F7FEEE] text-[#2D2B2B] h-full flex justify-center items-center px-3">
          <div className="flex flex-col items-center justify-center">
            <h3 className="first-hero-head hero-subtitle text-[#7ADD02] text-center">
              Elevate{" "}
              <span className="text-[#2D2B2B]">
                Your <br /> Communication Experience
              </span>
            </h3>
            <p className="first-hero-subtitle pt-6 pb-14">
            ...
            <div className="flex gap-5">
              ...
              <Link
                to={REGISTER}
                className="flex action-button border border-[#3D7100] bg-transparent text-[#2D2B2B] sm:mr-1"
              >
                learn more
              </Link>
            </div>
