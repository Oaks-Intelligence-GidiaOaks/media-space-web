...
function Footer() {
  ...
  return (
    <section className="footer w-full px-5 md:px-20 relative bg-[#EDF7DC]" id="support">
      ...
      <div className="pt-[64px] pb-[64px]">
        ...
        <div className="md:flex flex-row justify-evenly gap-10 pt-10">
        ...
        <p className="copyright text-[#838383] pt-10">© {currentYear}. Oaks Intelligence</p>
      </div>
