    ...
    <div className="px-3 pt-5 pb-5">
      ...
      <div className="flex gap-10 px-3 pt-5 flex-col lg:flex-row lg:gap-10">
        ...
        {user && user.role == "OrgAdmin" ? (
                ...
                <div className="company-card shadow-lg">
                  <div className="card-content p-3">
                    ...
                    <p className="company-desc w-10/12 pb-5">
                      ...
                      duis nisl commodo ac blandit. Elementum ipsum sapien id in
                      mattis.
                    </p>
          ...
          <>
            <div className="w-full super-admin-card-box flex flex-col items-center justify-center sm:flex-row sm:flex-wrap sm:justify-center sm:gap-10 md:grid md:grid-cols-2 md:justify-between lg:grid lg:grid-cols-4 xl:grid-cols-5">
              <Cards
                title={"67m"}
                subtitle={"Total post"}
                percentage={"10.2%"}
